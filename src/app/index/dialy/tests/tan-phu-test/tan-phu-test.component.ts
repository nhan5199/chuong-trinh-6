...
@Component({
  selector: 'app-tan-phu-test',
  templateUrl: './tan-phu-test.component.html',
  styleUrls: ['./tan-phu-test.component.css'],
})
export class TanPhuTestComponent implements OnInit {
