...
@Component({
  selector: 'app-xuan-loc-test',
  templateUrl: './xuan-loc-test.component.html',
  styleUrls: ['./xuan-loc-test.component.css'],
})
export class XuanLocTestComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.answerForm.value.cau1 == 'B') {
