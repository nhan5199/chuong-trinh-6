...
@Component({
  selector: 'app-bien-hoa-test',
  templateUrl: './bien-hoa-test.component.html',
  styleUrls: ['./bien-hoa-test.component.css'],
})
export class BienHoaTestComponent implements OnInit {
