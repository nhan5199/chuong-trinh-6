...
@Component({
  selector: 'app-thong-nhat-test',
  templateUrl: './thong-nhat-test.component.html',
  styleUrls: ['./thong-nhat-test.component.css'],
})
export class ThongNhatTestComponent implements OnInit {
