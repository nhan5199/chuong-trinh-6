...
@Component({
  selector: 'app-long-thanh-test',
  templateUrl: './long-thanh-test.component.html',
  styleUrls: ['./long-thanh-test.component.css']
})
export class LongThanhTestComponent implements OnInit {
