...
@Component({
  selector: 'app-long-khanh-test',
  templateUrl: './long-khanh-test.component.html',
  styleUrls: ['./long-khanh-test.component.css'],
})
export class LongKhanhTestComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.answerForm.value.cau4 == 'B') {
      this.point = this.point + 1;
    }
    ...
    if (this.answerForm.value.cau8 == 'C') {
      this.point = this.point + 1;
    }
    if (this.answerForm.value.cau9 == 'B') {
      this.point = this.point + 1;
    }
