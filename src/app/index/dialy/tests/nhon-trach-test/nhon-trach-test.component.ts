...
@Component({
  selector: 'app-nhon-trach-test',
  templateUrl: './nhon-trach-test.component.html',
  styleUrls: ['./nhon-trach-test.component.css'],
})
export class NhonTrachTestComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.answerForm.value.cau2 == 'C') {
      this.point = this.point + 1;
    }
